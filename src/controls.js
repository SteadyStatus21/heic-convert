...
const RESULTS_OPTIONS = [
  { text: 'Display Uploaded Images', value: 'display' },
  { text: 'Immediately Download Images', value: 'download' },
];
...
export default ({ events, menu, storage }) => {
  ...
  const onQuality = () => {
    const choices = [
      { meta: true, text: 'Choose your output and quality settings...' },
  ...
  const onResults = () => {
    const choices = [
      { text: 'What should I do after the conversion?', meta: true },
